...
public class FileViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
     ...
     *
     * @param v        The inflated layout for this view.
     * @param listener The instance of the parent to interact with it as a listener.
     */
     ...
     *
     * @param isDirectory  to know if this view corresponds to a directory.
     * @param name         the name of the file to display.
     * @param lastModified the date of the last modification of the file to display.
     * @param size         the size of the File
     * @param isSelected   to know if this File has been selected by the user. If the File is a directory this parameter does
     *                     not matter.
     */

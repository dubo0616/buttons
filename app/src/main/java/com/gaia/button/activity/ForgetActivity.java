...
public class ForgetActivity extends BaseActivity implements View.OnClickListener, IUserListener {
    ...
    private void checkBtnStatus(){
        if(mPhoneCode!= null && !TextUtils.isEmpty(mPhoneCode.getText())
                ...
                &&!TextUtils.isEmpty(mPassnew.getText().toString())
...
//            return;
//        }
        UserManager.getRequestHandler().requestForgetPass(ForgetActivity.this,mPhoneNumber.getText().toString().trim(),mPhoneCode.getText().toString().trim(),
                mPassnew.getText().toString(),mPassConfirm.getText().toString());
    }
    ...
    private boolean doSmsCode(){
        ...
        UserManager.getRequestHandler().requestGetCode(ForgetActivity.this,mPhoneNumber.getText().toString().trim());
        return true;
    }
    ...
    public void onRequestSuccess(int requestTag, Object data) {
        if(requestTag == ConstantUtil.Net_Tag_User_Login_FORGETPASS) {
            Toast.makeText(ForgetActivity.this,"找回密码成功,请重新登录",Toast.LENGTH_SHORT).show();
            startActivity(new Intent(ForgetActivity.this,PhonePassLoginActivity.class));
            finish();
    ...
    public void onRequestError(int requestTag, int errorCode, String errorMsg, Object data) {
        Toast.makeText(ForgetActivity.this,"找回密码失败",Toast.LENGTH_SHORT).show();

...
public class ArcSeekBarInner extends View {
    ...
    public ArcSeekBarInner(Context context) {
        this(context, null);
    }

    public ArcSeekBarInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcSeekBarInner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            }
    ...
    public interface OnProgressChangeListener {
         ...
         */
        void onProgressChanged(ArcSeekBarInner seekBar, int progress, boolean isUser);
         ...
         * @param seekBar 拖动条
         */
        void onStartTrackingTouch(ArcSeekBarInner seekBar);
         ...
         * @param seekBar 拖动条
         */
        void onStopTrackingTouch(ArcSeekBarInner seekBar);
    }
    // endregion -----------------------------------------------------------------------------------
}

...
public final class GAIA {
     ...
     */
    public static  int VENDOR_QUALCOMM = 0x000C;
    ...
    public static final int COMMAND_SET_ANC_CONTROL = 0x02B0;
    public static final int COMMAND_GET_ANC_CONTROL = 0x02B1;
    public static final int COMMAND_GET_AMBIENT_CONTROL = 0x02B2;
